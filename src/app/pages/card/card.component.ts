    ...
    '4': [
      {
        title: 'Кратко',
        items: [
          'Трапециевидное душевое ограждение — практичное решение для нестандартных ванных комнат и индивидуальных проектов. Такая форма подходит для небольших помещений, где нужно разместить сантехнику, мебель, стиральную машину или другие предметы и сохранить удобный проход.'
        ]
      },
      {
        title: 'Стекло',
        items: [
          'Доступные варианты: бесцветное, осветлённое, тонированное серое или бронза.',
          'Каждый вариант стекла может быть прозрачным или матовым.',
          'Рекомендуемая толщина стекла для этой конструкции: 8 мм.'
        ]
      },
      {
        title: 'Конструкция и размеры',
        items: [
          'Трапециевидная форма сложнее стандартных душевых ограждений, поэтому перед изготовлением лучше заранее получить техническое задание на организацию поддона. Это помогает избежать ошибок, которые могут привести к удорожанию конструкции.',
          'Угол между стационарным полотном и дверью должен быть 135 градусов, потому что фурнитура для такой конструкции рассчитана именно на этот угол.',
          'Небольшие отклонения можно компенсировать за счёт петель с регулировкой, но возможности регулировки ограничены.',
          'Для варианта 3 необходимо заранее уточнить наличие петель стекло-стена 135 градусов, так как такие петли редко бывают в наличии.'
        ]
      },
      {
        title: 'Фурнитура',
        items: [
          'Петли и ручки подбираются не только по цвету, но и по функциональности.',
          'Обычно размер двери в трапециевидных конструкциях не превышает 650-700 мм, поэтому усиленная и премиум-фурнитура чаще используется не из-за веса двери, а для защиты от протечек и компенсации небольших неточностей в организации поддона.',
          'Особенно это важно, если фактический угол отличается от расчётных 135 градусов.',
          'Петли могут быть с регулировкой нулевого положения и защитой от протечек; также доступны классические петли.',
          'Все петли изготовлены из латунного сплава.',
          'Ручки предлагаются в исполнениях: кноб, скоба и ручка-держатель полотенца.',
          'Материал ручек: нержавеющая сталь или латунь.',
          'Фурнитура доступна в цветах: хром, матовая нержавейка, чёрный, золото, матовое золото, бронза, оружейная сталь, розовое золото. Возможны матовое и глянцевое исполнения.'
      ...
      },
      {
        title: 'Индивидуальные решения',
        items: [
          'При необходимости могут быть выполнены индивидуальные решения: вырезы под инсталляцию, скошенные углы и другие нестандартные формы.'
        ]
      }
    ],
    '5': [
      {
        title: 'Кратко',
        items: [
          'Раздвижная система душевой двери идеально подходит для экономии пространства, сохраняя эстетичность и удобство.'
        ]
      },
      {
        title: 'Стекло',
      ...
      },
      {
        title: 'Конструкция и размеры',
        items: [
          'Размер конструкции начинается от 1200 мм по ширине, рекомендованная высота — не выше 2100 мм.',
          'Максимальная ширина составляет 2000 мм, при этом при ширине свыше 1500 мм устанавливается дополнительная рама жёсткости.',
          'Конструкция может быть встроена в проём либо иметь свои стеклянные стены с одной или с двух сторон, образуя форму угла или буквы П.'
        ]
      },
      {
        title: 'Фурнитура',
        items: [
          'Фурнитура предлагается в перечисленных вариантах: хром, матовая нержавейка, чёрный, золото, матовое золото, бронза, оружейная сталь, розовое золото — в матовом или глянцевом исполнении.',
          'В комплект входит круглая утопленная в стекло ручка, которую при желании можно заменить на другую модель с некоторыми ограничениями.'
        ]
      }
    ]
  };
